...
!!! abstract "¿Cuál es la huella material de la IA?"
    La IA no vive en una nube etérea: vive en edificios físicos que consumen **electricidad las 24 horas**, **agua para enfriar servidores** y **minerales extraídos en minas de todo el mundo**. Los centros de datos consumen ~1.5% del consumo eléctrico global y se proyecta que esa cifra se duplique para 2030.[^19] El costo no se distribuye igual: América Latina contribuye solo el 6.7% de las emisiones globales pero absorbe una parte importante de los costos ambientales de la infraestructura digital.[^25] **El objetivo de este módulo es ponerle cifras al “mito de la nube” (energía, agua, minerales, basura electrónica) y entender quién paga ese costo, cómo se distribuye y qué podemos hacer al respecto.**

![El mito de la nube](images/09_MitoLaNube.png)

## La infraestructura física detrás de lo digital

Cuando la IA “aprende” o “responde”, todo ese proceso ocurre en edificios físicos conectados por cables submarinos. Casi el **100% del tráfico de internet** pasa por cables de fibra óptica tendidos en el fondo del océano.[^3] Esos cables conectan a los centros de datos, edificios que concentran la infraestructura informática necesaria para crear, ejecutar y proporcionar aplicaciones y servicios, entre ellos correr modelos de IA.[^35]
...
<div class="quiz" data-correct="b" data-explanation="El problema m&aacute;s profundo es la fuente de la energ&iacute;a. Casi la mitad de la electricidad que consumen los centros de datos en EE.UU. viene de combustibles f&oacute;siles, y los reguladores ya est&aacute;n aprobando nuevas plantas de gas natural para alimentar centros como Meta Hyperion. La opci&oacute;n (a) trata el problema solo como escala, pero construir m&aacute;s plantas mueve el costo sin resolverlo. La opci&oacute;n (c) atiende un s&iacute;ntoma (eficiencia por consulta) en lugar de la causa estructural (la matriz energ&eacute;tica).">
<p class="quiz-title">Ponte a prueba: En 2024 los centros de datos a nivel mundial consumieron <strong>415 TWh</strong> de electricidad (~1.5% del consumo global) y la AIE proyecta que esa cifra <strong>se duplique para 2030</strong>. Según el módulo, ¿cuál es el problema más profundo de este consumo?</p>
<label class="quiz-option"><input type="radio" name="q-energia-centros" value="a"> La escala absoluta: para cubrir la demanda hay que construir más plantas eléctricas</label>
<label class="quiz-option"><input type="radio" name="q-energia-centros" value="b"> De dónde viene esa electricidad: casi la mitad del consumo en EE.UU. proviene de combustibles fósiles</label>
<label class="quiz-option"><input type="radio" name="q-energia-centros" value="c"> Que cada consulta individual a un modelo es muy ineficiente y debería optimizarse</label>
...
??? example "Conoce más sobre Sasha Luccioni"
    Sasha Luccioni es investigadora franco-canadiense y líder de clima en [Hugging Face](https://huggingface.co/sasha). Su trabajo ha sido pionero en medir las emisiones reales de modelos de IA: desde calcular la huella de carbono completa de BLOOM[^6] hasta demostrar que generar una imagen consume 1,450 veces más energía que clasificar un texto.[^14] Es una de las voces más visibles en la intersección de IA y cambio climático.
...
La mayoría de estas cifras son estimaciones de investigadores independientes, no datos oficiales. De las principales compañías de IA, la gran mayoría no divulga métricas ambientales desagregadas sobre su consumo energético, emisiones de carbono o uso de agua.[^36] Las personas que investigan, la prensa y la sociedad civil deben inferir el consumo a partir de datos indirectos como envíos de chips, eficiencia estimada y composición de cargas de trabajo, lo que explica por qué las estimaciones varían ampliamente entre estudios.[^36] Y cuando las empresas sí publican datos, no siempre reflejan la realidad.
...
!!! warning "¿Qué son los RECs y por qué importan?"
    Las empresas tecnológicas afirman operar con energía renovable comprando Certificados de Energía Renovable (RECs). Es decir, compran créditos de alguien que produce energía verde en otro lugar, mientras sus centros de datos funcionan con carbón y gas natural de forma local; esto les permite reportar que son carbono neutrales o negativas, a pesar de que sus emisiones reales sigan aumentando. Es el equivalente a afirmar que reciclas porque compraste un bono de reciclaje de alguien en otro país, pero tirar cada vez más basura en tu propio país.[^12]
...
El panorama es complejo, pero no está fuera de nuestro control. Necesitamos más y mejores polítcias públicas que pongan al centro a las personas y las comunidades para reducir el impacto ambiental de las tecnologías digitales y la IA.

### Iniciativas y regulación internacional

| Iniciativa | Qué propone | Estado |
|------------|-------------|--------|
| **Acuerdo de Escazú** (LatAm, desde 2021) | Garantiza derechos de acceso a información ambiental, participación pública y justicia. Herramienta legal clave en los fallos contra centros de datos de Google en Chile y Uruguay[^32] | Vigente |
...
| **Política federal EE.UU.** (Trump, 2025) | Revocó las directrices previas de IA y, con el plan *Winning the AI Race* (jul 2025), acelera permisos de centros de datos eliminando los requisitos de reporte climático y DEI previos.[^43] | Desregulación activa |

### Técnicas para hacer más eficientes los modelos
...
<label class="checklist-item"><input type="checkbox"> Explicar por qué “la nube” es un mito y describir la infraestructura física detrás de un servicio de IA</label>
<label class="checklist-item"><input type="checkbox"> Citar al menos dos cifras concretas (energía, agua o emisiones) que dimensionen el costo ambiental de la IA</label>
<label class="checklist-item"><input type="checkbox"> Distinguir entre la Paradoja de Jevons y el greenwashing (RECs) como problemas distintos pero relacionados</label>
<label class="checklist-item"><input type="checkbox"> Identificar al menos un caso concreto de impacto ambiental de la IA en América Latina (agua, litio o minería)</label>
...
[^43]: The White House (23 jul 2025). “Fact Sheet: President Donald J. Trump Accelerates Federal Permitting of Data Center Infrastructure.” <https://www.whitehouse.gov/fact-sheets/2025/07/fact-sheet-president-donald-j-trump-accelerates-federal-permitting-of-data-center-infrastructure/>
